...
function getLessonCatalog(): array
{
    ...
    $lessons = [
        [
            ...
            'duration_minutes' => 3,
            'format' => 'exercise',
            'short_description' => 'Use a steady 4-4-4-4 breathing rhythm to settle nerves before training, practice, performance, or competition.',
            'why_this_works' => 'Slow, paced breathing can lower stress arousal, improve emotional control, and make attention shifts easier.',
            'when_to_use' => 'Before warm-up, a session, an event, or any moment when intensity spikes.',
            'try_now_steps' => [
            ...
            'external_video_url' => 'https://www.youtube.com/results?search_query=box+breathing+for+performance',
        ...
        [
            ...
            'when_to_use' => 'After a mistake, during a pause, or before re-entry.',
            'try_now_steps' => [
        ...
        [
            ...
            'when_to_use' => 'Before an attempt, during a break, or between sets.',
            'try_now_steps' => [
        ...
        [
            ...
            'duration_minutes' => 2,
            'format' => 'session',
            'short_description' => 'Use a three-part reset routine to interrupt frustration and return to the next action.',
            'why_this_works' => 'A repeatable post-error routine reduces rumination and improves emotional recovery speed.',
            'when_to_use' => 'Immediately after a mistake, miss, or tactical error.',
            'try_now_steps' => [
        ...
        [
            ...
            'duration_minutes' => 4,
            'format' => 'session',
            'short_description' => 'Ground your body and attention before a meaningful action with a short sensory anchor routine.',
            'why_this_works' => 'Grounding shifts attention from worry loops toward present-moment cues and body control.',
            'when_to_use' => 'Before an event, presentation, set, drill, or high-pressure moment.',
            'try_now_steps' => [
            ...
            'external_video_url' => 'https://www.youtube.com/results?search_query=grounding+exercise+performance',
        ...
        [
            ...
            'title' => 'Visualization for the Next Action',
            ...
            'external_video_url' => 'https://www.youtube.com/results?search_query=performance+imagery+mental+rehearsal',
        ...
        [
            ...
            'duration_minutes' => 3,
            'format' => 'script',
            'short_description' => 'Use label, release, refocus to move through frustration without carrying it to the next action.',
        ...
        [
            ...
            'when_to_use' => 'Within 30 minutes after training, practice, work, performance, or competition.',
            'try_now_steps' => [
        ...
        [
            ...
            'try_now_steps' => [
                'Pick one cue phrase: tall and smooth, calm and direct, or own this action.',
        ...
        [
            ...
            'try_now_steps' => [
                ...
                'Rate your focus from 1 to 5 after one attempt.',
            ],
            'external_video_url' => 'https://www.youtube.com/results?search_query=attention+control+training+performance',
        ...
        [
            ...
            'try_now_steps' => [
                ...
                'Run the first action now to lock in the cue.',
            ],
            'external_video_url' => null,
        ...
        [
            ...
            'why_this_works' => 'Small, completed actions lower resistance and rebuild behavioral momentum.',
            'when_to_use' => 'When a goal feels heavy, stalled, or easy to avoid.',
            'try_now_steps' => [
                'Define the smallest meaningful action you can finish today.',
                'Set a 2-minute timer and begin immediately.',
                'Mark it complete before scaling anything up.',
                'Choose tomorrow\'s first tiny action now.',
            ],
            'external_video_url' => null,
        ...
        [
            ...
            'when_to_use' => 'After missed check-ins, skipped actions, or repeated stop-start cycles.',
            'try_now_steps' => [
                'Name the blocker from your last missed action.',
        ...
        [
            ...
            'when_to_use' => 'At the end of your week or cadence window before setting the next action.',
            'try_now_steps' => [
